<script lang="ts">
	...
	import { Landmark, Mail } from 'lucide-svelte';
...
<div class="mx-auto flex max-w-md flex-col items-center px-4 py-16">
	...
	<!-- Mode switcher -->
	<div class="mt-6 grid w-full grid-cols-2 gap-1 rounded-xl bg-slate-100 p-1">
		{#each [['login', 'Login'], ['register', 'Daftar']] as [m, label] (m)}
			<button
